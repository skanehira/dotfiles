...
コンテンツの内容を把握したら、ビジュアルの方向性を**提案**する。

スライドの内容・テーマ・対象者を踏まえて、以下の3点を具体的に提案する：

1. **トーン**: このプレゼンにふさわしい「空気感」を一言で提案し、その理由を添える
2. **差別化**: このスライドを見た人が一番覚えているべきことを提案する
3. **参照イメージ**: コンテンツに合うブランド、Webサイト、雑誌のテイスト等を提案する

提案後、ユーザーに以下を確認する：
- この方向性で進めてよいか
- 修正したい点があるか（トーンの変更、差別化ポイントの調整など）
