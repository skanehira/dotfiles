...
- [概要](#概要)
- [参照ドキュメント](#参照ドキュメント)
- [質問のプレースホルダーについて](#質問のプレースホルダーについて)
- [ワークフロー](#ワークフロー)
  - [フェーズ0: 前提ドキュメントの読み込み](#フェーズ0-前提ドキュメントの読み込み)
  - [フェーズ1: ドメインの概要把握](#フェーズ1-ドメインの概要把握)
  - [フェーズ2: ユビキタス言語の収集](#フェーズ2-ユビキタス言語の収集)
  - [フェーズ3: 境界づけられたコンテキストの特定](#フェーズ3-境界づけられたコンテキストの特定)
  - [フェーズ4: ドメインモデルの構築](#フェーズ4-ドメインモデルの構築)
  - [フェーズ5: 検証と確認](#フェーズ5-検証と確認)
...
- **DDDパターン**: [ddd-patterns.md](ddd-patterns.md)
