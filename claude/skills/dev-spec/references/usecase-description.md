...
- [参照ドキュメント](#参照ドキュメント)
- [ワークフロー](#ワークフロー)
  - [フェーズ1: 対象ストーリーの選択](#フェーズ1-対象ストーリーの選択)
  ...
  - [フェーズ8: ドキュメント生成](#フェーズ8-ドキュメント生成)
  - [出力ファイル](#出力ファイル)
  - [フェーズ9: ユースケース図の生成（オプション）](#フェーズ9-ユースケース図の生成オプション)
  - [フェーズ10: セルフレビュー（サブエージェント）](#フェーズ10-セルフレビューサブエージェント)
- [完了条件](#完了条件)
- [関連スキル](#関連スキル)
