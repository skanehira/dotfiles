...
- `日数` 省略時: 直近 **7 日**
- 例: `/utility-self-improving 14` で直近 14 日
...
これは「自動学習が誤っていないか」を人間がレビューするための判断材料である。観測根拠が無いと、ユーザーが PR を見ても採否を判断できない。**観測根拠のないインラインコメントを付けるくらいなら、付けない**。
