...
質問は番号付き (Q1/Q2...) + 選択肢 (A/B/C) 形式にし、ユーザーが「1: A、2: B」のように短く答えられる構造にする。{{@ask-user}} ツールを使ってもよい。選択肢は回答を引き出すための例であり、ユーザーの自由回答を常に優先する。回答が曖昧な場合は具体例を挙げて確認する。
...
承認後、{{@invoke-skill}}で `slide-plugin:slide-deck-builder` を起動する。args には以下を渡す:
