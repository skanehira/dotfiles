...
{{@ask-user}} で「このドキュメントを読んで何ができればよいか」を確認する:
...
未知候補を {{@ask-user}} (multiSelect) で提示し、ユーザに「知っているもの」を選んでもらう。概念が 5 個を超える場合は、本文理解への影響が大きい順に絞るかグループ化して、確認の往復が 1〜2 回で済むようにする。
